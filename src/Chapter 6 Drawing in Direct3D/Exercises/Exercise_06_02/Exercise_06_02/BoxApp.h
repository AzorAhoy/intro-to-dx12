...
BoxApp::BoxApp(HINSTANCE hInstance)
    : D3DApp(hInstance)
{
    mMainWndCaption = L"Exercise 6.2";
}
...
void BoxApp::BuildBoxGeometry()
{
    ...
    const UINT cbByteSize = (UINT)vertices.size() * sizeof(VColorData);
    ...
    mBoxGeo->ColorBufferGPU = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(),
        mCommandList.Get(), colors.data(), cbByteSize, mBoxGeo->ColorBufferUploader);
